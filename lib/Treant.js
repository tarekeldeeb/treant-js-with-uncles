    ...
    Tree.prototype = {
        ...
        addUncles: function (){
            this.getNodeDb().db.forEach(function(n){
                if(!n.hidden && n.uncles.length > 0 ){
                    ...
                    for(u in n.uncles){
                        //console.log('Connection Store= '+ this.connectionStore[n.id].length);
                        //console.log('Connection Store= '+ JSON.stringify(this.connectionStore[n.id][u]));
        ...
        setConnectionToParent: function( treeNode, hidePoint ) {
            ...
            if ( this.connectionStore[treeNode.id] ) {
                ...
                connLine = this.connectionStore[treeNode.id][0];
