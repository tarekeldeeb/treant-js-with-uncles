                        ...
                        if ( this.connectionStore[node.id].length > 1 ) {
                            ...
                            this.connectionStore[node.id].slice(1).forEach(function(c,cidx){
                                pathString = hidePoint?
                                    ...
                                    this.tree.getPathString(this.tree.getNodeDb().getNodeByName(node.uncles[cidx].text.name), node, stacked);
                            ...
                            for(u in node.uncles){
                                pathString = hidePoint?
                                    ...
                                    this.getPathString(this.getNodeDb().getNodeByName(node.uncles[u].text.name), node, stacked);
